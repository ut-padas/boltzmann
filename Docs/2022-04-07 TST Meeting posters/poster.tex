...
\begin{itemize}[leftmargin=*]
  ...
  \item[--] \textbf{Y3 Goal:} Need to couple plasma model with electron kinetics (planned for Y3)
\end{itemize}
...
\item[--] Maxwell polynomials tends to have faster convergence rate than B-splines. 
