...
\begin{align*}
	h_a\of{\vect{v}} &= \sum_{l} \frac{m_a + m_b}{m_b} f^{b}_l\of{v} Y_{l0}\of{\vtheta, \vphi} \text{ where } \\
	f^{b}_l\of{v} &= \frac{4\pi}{(2l+1)}\of{\int_{0}^{v} dv^\prime \frac{{v^\prime}^{l+2}}{v^{l+1}} f^{b}_l\of{v^\prime} +  \int_{v}^{\infty} dv^\prime \frac{{v}^{l}}{{v^\prime}^{l-1}} f^{b}_l\of{v^\prime}}\\
