...
%				\end{align}
				\item Steady state equations become%s (assuming $l=0,1$ and $m=0$ modes), 
				\begin{align}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Use lower-order B-Splines for glow discharge \& torch simulations. %For time-being we are planning to move forward with low-order B-Spline approximations 
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace*{-0.2in}
	\begin{center}
		\includegraphics[width=0.73\textwidth]{glow_discharge_1d3v_g0_g2_v0_z01.00E+02_poly_bspline_sp_2_nz800_nr128_lmax4_qpn4_qvt6_ev2.00E+01_bscale1.0_ne_fac8.00E+16_vx_max_1.11E+01_dt1.00E-12_T3.69E-07_qoi.png}
	\end{center}
	}
	...
	\vspace*{-0.2in}
	\begin{center}
		\includegraphics[width=0.96\textwidth]{glow_discharge_1d3v_g0_g2_v0_z01.00E+02_poly_bspline_sp_2_nz800_nr128_lmax4_qpn4_qvt6_ev2.00E+01_bscale1.0_ne_fac8.00E+16_vx_max_1.11E+01_dt1.00E-12_T3.69E-07_vt_z_plt.png}
	\end{center}
	}
