...
\begin{document}
	...
	\begin{frame}
		...
		\textbullet~ Uses Gaussian filter
		\only<+>{
		\begin{table}
			\begin{tabular}{||c|c|c||}
				\hline
				$N_r$ & \lxcat & \lxcat~+ smoothing\\
				\hline
				4 & 5.47E-02 & 5.50E-02\\
				8 & 1.17E-02 & 1.19E-02\\
				16 & 4.17E-03 & 4.27E-03\\
				32 & 2.47E-03 & 2.08E-03\\
				64 & 2.27E-03 & 1.49E-03 \\
				100 & 7.02E-04 & 4.51E-04 \\
				\hline
			\end{tabular}
			\caption{spectral norms at $T=1e-6$}
		\end{table}
		}
		\begin{figure}
			\only<+>
