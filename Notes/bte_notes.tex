...
\begin{align*}
f = M\of{\textstyle\frac{v}{\vth}} \sum_{klm} a_{klm} P_k\of{\textstyle\frac{v}{\vth}} Y_{lm}\of{\theta,\phi}
\end{align*}

\begin{align*}
\nabla_{\vect{v}} f = \sum_{klm} a_{klm} 
\left(
\frac{d \left(M\of{\textstyle\frac{v}{\vth}} P_k\of{\textstyle\frac{v}{\vth}} \right)}{dv}  \vect{Y}_{lm}\of{\theta,\phi}
+
\frac{\left(M\of{\textstyle\frac{v}{\vth}} P_k\of{\textstyle\frac{v}{\vth}} \right)}{v}  \vect{\Psi}_{lm}\of{\theta,\phi}
\right)
\end{align*}
...
\sum_{klm} 
b_{klm} 
M\of{\textstyle\frac{v}{\vth}} P_k\of{\textstyle\frac{v}{\vth}}  \hat{\vect{v}} Y_{lm}\of{\theta,\phi} 
+
\sum_{klm} 
a_{klm}
M\of{\textstyle\frac{v}{\vth}} P_k\of{\textstyle\frac{v}{\vth}} 
\nabla_{\vect{v}} Y_{lm}\of{\theta,\phi}
\end{align*}

\begin{align*}
\vect{Y}_{lm}\of{\theta,\phi} &= \hat{\vect{v}} Y_{lm}\of{\theta,\phi} 
\\
\vect{\Psi}_{lm}\of{\theta,\phi} &= v \nabla_{\vect{v}} Y_{lm}\of{\theta,\phi}
\end{align*}
