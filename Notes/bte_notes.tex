...
\newpage
Bolsig+ reports distributions $F_0\of{\varepsilon}$ and $F_1\of{\varepsilon}$, which are defined as:
\begin{align*}
f\of{\vect{v},t} = \frac{n\of{t}}{2\pi \gamma^3} \left( F_0\of{\varepsilon} + F_1\of{\varepsilon} \cos\of{\theta} \right)
\end{align*}
where $\gamma = \sqrt{\frac{2 e}{m}}$ and $\varepsilon = \left( \frac{v}{\gamma} \right)^2$. In terms of exact spherical harmonics $Y_{00} = \frac12 \sqrt{\frac1\pi}$ and $Y_{10} = \frac12 \sqrt{\frac3\pi}$ it becomes:
\begin{align*}
\frac{f\of{\vect{v},t}}{n\of{t}} = \frac{F_0\of{\varepsilon}}{\pi \gamma^3}  + F_1\of{\varepsilon} \cos\of{\theta}
\end{align*}
