...
% -- Set talk title here
Solving the Boltzmann transport equation (BTE) for electron kinetics %using Galerkin approach
% --
}
\end{columns}
\vspace*{.15cm}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.3\textwidth}
			\includegraphics[width=\columnwidth]{glow1.png}
		\end{column}
	\end{columns}
	% \begin{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{align*}
		\item B-splines + SPH in v-space +  Chebyshev-collocation %representation of $f$ in the velocity-space for collision and v-space advection
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=\textwidth]{glow1d_adv_x_1.png} 
	\end{center}
	\begin{itemize}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.48\textwidth]{1v_0.png}
		\includegraphics[width=0.48\textwidth]{1v_1.png}
	\end{center}
	\begin{itemize}
		\item 1D-BTE solver improvements
