...
import numpy as np
import math
import collision_operator_spherical
...
maxwell = basis.Maxwell()

# instance of the collision operator
cf    = collision_operator_spherical.CollisionOpElectronNeutral3DSpherical(PARS.VEL_SPACE_POLY_ORDER, PARS.SPH_HARM_LM, PARS.NUM_Q_PTS_ON_V, PARS.NUM_Q_PTS_ON_SPHERE, maxwell)
...
maxwellian = lambda x: np.exp(-x**2)/np.pi**1.5
