...
parser.add_argument("-run_serires", "--run_series" , help="run series, E/N (min) E/N (max), num points grid type (1-linear, 2-quadratric, 3-exponential)", nargs='+', type=float, default=[1e-2, 1e2, 100, 1])
