...
\end{align}. In the generalized coordinates, we can write, the equation in the covariant form as follows. 
\begin{align*}
	\Gamma_a ^{-1} \partial_t f_a = -D_\mu (f {T_a}^{\mu}_{\nu} ) + \frac{1}{2} D_{\mu\nu}\of{f {S_a}^{\mu\nu}} 
\end{align*} where $D_{\mu}$ denotes the covarient derivative with respect to metric $a_{\mu\nu}$ , ${T_a}^{\mu}_{\nu} = a^{\mu\nu} D_\nu h_a$ and $S^{\mu\nu} = a^{\mu\omega} a^{\nu \tau} D_{\omega \tau} g$. For basis, $q_1 = v, q_2 = \cos\vtheta, q_3 = \vphi$ we can simplify the above as follows where $\mu=\cos\vtheta$. 
\begin{align*}
...
\begin{align*}
	f_a\of{\vect{v}} = \sum_{l} f^{a}_l\of{v} Y_{l0}\of{\vtheta, \vphi}
\end{align*}. Then we can derive \cite{rosenbluth1957fokker}, 
\begin{align*}
	h_a\of{\vect{v}} &= \sum_{l} \frac{m_a + m_b}{m_b} A^{b}_l\of{v} Y_{l0}\of{\vtheta, \vphi} \text{ where } \\
	A^{b}_l\of{v} &= \frac{4\pi}{(2l+1)}\of{\int_{0}^{v} dv^\prime \frac{{v^\prime}^{l+2}}{v^{l+1}} f^{b}_l\of{v^\prime} +  \int_{v}^{\infty} dv^\prime \frac{{v}^{l}}{{v^\prime}^{l-1}} f^{b}_l\of{v^\prime}}\\
...
\end{align*}
Using the two term expansion and neglecting all  the quadratic terms in $f_1$, we can derive, 
\begin{align*}
&v^2	\Gamma_a ^{-1}  \partial_t f_0  = \partial_v \of {\alpha P^2_0 f_0 + \frac{1}{3v}\of{P^4_0 + v^3 Q^1_0} \partial_v f_0}\\
&v^2	\Gamma_a ^{-1}  \partial_t f_1  = -\frac{1+\alpha}{v} \of{P^2_0 f_1 -v^2 Q^0_1 f_0} + \\
&\frac{1}{v}\partial_v \Bigg(\alpha v P^2_0 f_1 + \frac{1}{3} v\of{P^4_0 + v^3 Q^1_0} \partial_v \of{f_1/v} \\
&+ \frac{1}{3}\of{(2\alpha -1 ) P^3_1 - (1 + \alpha) v^3 Q^0_1}f_0 + \frac{1}{5v}\of{P^5_1 + v^5 Q^0_1} \partial_v f_0 \Bigg)
\end{align*} where $\alpha = m_a/m_b$ mass ratio of the particles. 
we can write the week form of the the above, as, 
\begin{align*}
	&\int T(v) v^2 \partial_t f_0 dv = - \Gamma_a \int \of{\alpha P^2_0 f_0 + \frac{1}{3v}\of{P^4_0 + v^3 Q^1_0} \partial_v f_0} \partial_v T(v) dv\\
	&\int T(v) v^2 \partial_t f_1 dv = - \Gamma_a \int \frac{1+\alpha}{v} \of{P^2_0 f_1 -v^2 Q^0_1 f_0} T(v) dv + \\
	&-\Gamma_a \int \partial_v \of{T(v)/v} \Bigg(\alpha v P^2_0 f_1 + \frac{1}{3} v\of{P^4_0 + v^3 Q^1_0} \partial_v \of{f_1/v}\\
	&+ \frac{1}{3}\of{(2\alpha -1 ) P^3_1 - (1 + \alpha) v^3 Q^0_1}f_0 + \frac{1}{5v}\of{P^5_1 + v^5 Q^0_1} \partial_v f_0 \Bigg) dv
\end{align*}. We can write the discretized operators, 
\begin{align*}
	&C^{0q}_{pk} = - \delta^{0q}\Gamma_a \int \of{\alpha P^2_0 S_k + \frac{1}{3v}\of{P^4_0 + v^3 Q^1_0} \partial_v S_k} \partial_v\of{T_p\of{v}} dv\\
	&C^{10}_{pk} = \Gamma_a \int (1+\alpha) \of{v Q^0_1 S_k(v)} T_p(v) dv -\\
	&\Gamma_a \int \of{\frac{1}{3}\of{(2\alpha -1 ) P^3_1 - (1 + \alpha) v^3 Q^0_1}S_k + \frac{1}{5v}\of{P^5_1 + v^5 Q^0_1} \partial_v S_k } \partial_v \of{T(v)/v} dv \\
	&C^{11}_{pk} = -\Gamma_a \int  \frac{1+\alpha}{v} P^2_0 S_k(v) T_p(v) dv - \Gamma_a \int \Bigg(\alpha v P^2_0 S_k + \frac{1}{3} v\of{P^4_0 + v^3 Q^1_0} \partial_v \of{S_k/v}\Big) \partial_v\of{T_p(v)/v}
\end{align*} where, 
\begin{align*}
	P^{m}_{0,1} = 4\pi \int_{0}^{v} {v^\prime}^m f^b_{0,1}(v^\prime) dv^\prime\\
	Q^{m}_{0,1} = 4\pi \int_{v}^{\infty} {v^\prime}^m f^b_{0,1}(v^\prime) dv^\prime \\
...
\end{align*} Let $\Omega_v$ be the domain for the radial coordinate, let $x=v/v_{th}$ denotes the normalizes coordinate for the radial component of the velocity. Following the same notation let $S_{k}\of{x}$ and $T_{p}\of{x}$ be the trial and test basis for the radial direction.  
\begin{align*}
