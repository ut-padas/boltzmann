...
class glow1d_boltzmann():
    ...
    def step_bte_vx_with_E(self, Uin, Vin, time, dt, verbose=0):
      ...
      v1       = xp.dot(self.op_psh2o, xp.dot(self.op_po2sh, v1))
      v1[v1<0] = 1e-16
