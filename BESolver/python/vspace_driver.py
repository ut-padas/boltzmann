...
fig.savefig("%s_bspline_eedf.png"%args.f_prefix)
plt.show()
plt.close()
...
fig = plt.gcf()
fig.set_size_inches(16, 8)
fig.savefig("%s_bspline_eedf_conv.png"%args.f_prefix)
plt.show()
plt.close()
...
fig = plt.gcf()
fig.set_size_inches(16, 8)
fig.savefig("%s_maxwell_eedf.png"%args.f_prefix)
plt.show()
plt.close()
...
fig = plt.gcf()
fig.set_size_inches(16, 8)
fig.savefig("%s_maxwell_eedf_conv.png"%args.f_prefix)
plt.show()
plt.close()
...
fig = plt.gcf()
fig.set_size_inches(16, 8)
fig.savefig("%s_bspline_vs_maxwell.png"%args.f_prefix)
plt.show()
plt.close()
