...
\subsection{G0: $e + Ar \rightarrow e + Ar $}
\begin{figure}[H]
    \includegraphics[width=\textwidth]{dat/g0_dt_1e-8_Nr_8.dat.png}
    \caption{G0 collision operator with $dt=1e-8$, $N_r=8$, $N_\theta=2$, and $N_\phi=1$, with $f(v,0)= M(v)h(v)$, with $h(v)=1$.}
\end{figure}
